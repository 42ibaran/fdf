...
/*   Updated: 2019/06/01 13:08:57 by ibaran           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
size_t	put_message(t_fdf **fdf)
{
	...
	mlx_string_put(POINTERS, 750, 950, 0xFFFFFF, "Authors: Ivan Baran and ");
	mlx_string_put(POINTERS, 750, 970, 0xFFFFFF, "Cristina Fernandez Bornay");
	return (0);
}
